package com.eden.javafx.calendar;
...
public class FXCalendar extends HBox {
	...
	private SimpleDoubleProperty dateTextWidth = new SimpleDoubleProperty(150);
	...
	public FXCalendar() {
		...
		this.baseColor.set(Color.web("#100A20", 0.3));
		//setSpacing(6);
	...
	private void configureCalendar() {
		...
		dateTxtField.getStyleClass().add("date_input");
...
//		dateTxtField.focusedProperty().addListener(this.focusOutListener);
	...
	public void showDateInTextField() {
		...
		if (date != 0 && month != -1 && year != 0) {
			...
			value.set(fxCalendarUtility.convertStringtoDate(year + "-" + month + "-" + date)) ;
		} else {
	...
	public Date getValue() {
		return fxCalendarUtility.convertStringtoDate(dateTxtField.getText()) ;
